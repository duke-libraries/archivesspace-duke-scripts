...
-->
    ...
    <xsl:template match="/">
        ...
        <xsl:text>parent series number</xsl:text>
        <xsl:value-of select="$tab"/>
        
        <xsl:text>parent series title</xsl:text>
        <xsl:value-of select="$tab"/>
        
        <xsl:text>parent series dates</xsl:text>
        <xsl:value-of select="$tab"/>
        
        <xsl:text>parent subseries number</xsl:text>
        <xsl:value-of select="$tab"/>
        
        <xsl:text>parent subseries title</xsl:text>
        <xsl:value-of select="$tab"/>
        
        <xsl:text>parent subseries dates</xsl:text>
        <xsl:value-of select="$tab"/>
        
        <xsl:text>descriptive_level</xsl:text>
        <xsl:value-of select="$tab"/>
...
<!-- ################################################################## -->        
        ...
        <!-- Get all components at levels defined below -->
        <xsl:for-each select="//ead:*[@level = 'series']|//ead:*[@level = 'subseries']|//ead:*[@level = 'file']|//ead:*[@level = 'item']">
            ...
            <!-- Descriptive level (@level). For making sense out of highly nested organization -->
